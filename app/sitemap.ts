...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const english: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/templates`, lastModified: new Date("2026-09-05"), changeFrequency: "weekly", priority: 0.9 },
    { url: `${base}/templates/business`, lastModified: new Date("2026-09-05"), changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/templates/business-plan-presentation`, lastModified: new Date("2026-09-05"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/templates/startup-pitch-deck`, lastModified: new Date("2026-09-05"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/templates/company-profile-presentation`, lastModified: new Date("2026-09-05"), changeFrequency: "monthly", priority: 0.8 },
  ];
  const localized: MetadataRoute.Sitemap = locales.filter((locale) => locale !== "en").flatMap((locale) => [
    ...
    ...templates.map((template) => ({ url: `${base}${localizePath(locale, `/templates/${template.slug}`)}`, lastModified: new Date("2026-09-06"), changeFrequency: "monthly" as const, priority: 0.8 })),
  ]);
