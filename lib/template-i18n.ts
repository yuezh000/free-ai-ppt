...
const localized20260911Round2Names: Partial<Record<Locale, Record<string, [string, string]>>> = {
  "zh-CN": {
    "precision-agriculture-business-plan": ["免费精准农业商业计划 PowerPoint 模板", "精准农业商业计划"],
    "regenerative-food-marketplace-pitch-deck": ["免费有机食品创业融资路演 PowerPoint 模板", "再生食品市场路演"],
    "mobile-kitchen-company-profile": ["免费餐车公司介绍 PowerPoint 模板", "移动厨房公司介绍"],
    "artisan-bakery-marketing-plan": ["免费烘焙店营销计划 PowerPoint 模板", "手工烘焙营销计划"],
    "neighborhood-produce-market-proposal": ["免费生鲜市场项目提案 PowerPoint 模板", "社区生鲜市场提案"],
    "consultative-sales-strategy-report": ["免费销售策略报告 PowerPoint 模板", "顾问式销售策略报告"],
    "water-cycle-science-lesson": ["免费水循环科学课 PowerPoint 模板", "水循环科学课"],
    "adaptive-reuse-architecture-thesis-defense": ["免费建筑学论文答辩 PowerPoint 模板", "适应性再利用建筑答辩"],
    "cardiac-rehabilitation-clinical-case": ["免费心脏病学临床病例 PowerPoint 模板", "心脏康复临床病例"],
    "machine-learning-model-evaluation": ["免费机器学习演示 PowerPoint 模板", "机器学习模型评估"],
    "independent-musician-portfolio": ["免费音乐人作品集 PowerPoint 模板", "独立音乐人作品集"],
    "product-launch-timeline-roadmap": ["免费产品发布路线图 PowerPoint 模板", "产品发布路线图"],
  },
  "zh-TW": {
    "precision-agriculture-business-plan": ["免費精準農業商業計畫 PowerPoint 範本", "精準農業商業計畫"],
    "regenerative-food-marketplace-pitch-deck": ["免費有機食品新創募資簡報範本", "再生食品市場簡報"],
    "mobile-kitchen-company-profile": ["免費餐車公司介紹 PowerPoint 範本", "行動廚房公司介紹"],
    "artisan-bakery-marketing-plan": ["免費烘焙店行銷計畫 PowerPoint 範本", "手工烘焙行銷計畫"],
    "neighborhood-produce-market-proposal": ["免費生鮮市場專案提案 PowerPoint 範本", "社區生鮮市場提案"],
    "consultative-sales-strategy-report": ["免費銷售策略報告 PowerPoint 範本", "顧問式銷售策略報告"],
    "water-cycle-science-lesson": ["免費水循環科學課 PowerPoint 範本", "水循環科學課"],
    "adaptive-reuse-architecture-thesis-defense": ["免費建築論文答辯 PowerPoint 範本", "適應性再利用建築答辯"],
    "cardiac-rehabilitation-clinical-case": ["免費心臟病學臨床病例 PowerPoint 範本", "心臟復健臨床病例"],
    "machine-learning-model-evaluation": ["免費機器學習簡報 PowerPoint 範本", "機器學習模型評估"],
    "independent-musician-portfolio": ["免費音樂人作品集 PowerPoint 範本", "獨立音樂人作品集"],
    "product-launch-timeline-roadmap": ["免費產品發布路線圖 PowerPoint 範本", "產品發布時間軸路線圖"],
  },
  ja: {
    "precision-agriculture-business-plan": ["無料精密農業事業計画 PowerPoint テンプレート", "精密農業事業計画"],
    "regenerative-food-marketplace-pitch-deck": ["無料オーガニック食品スタートアップ・ピッチデッキ", "再生型食品市場ピッチ"],
    "mobile-kitchen-company-profile": ["無料フードトラック会社概要 PowerPoint テンプレート", "モバイルキッチン会社概要"],
    "artisan-bakery-marketing-plan": ["無料ベーカリーマーケティング計画 PowerPoint", "職人ベーカリー計画"],
    "neighborhood-produce-market-proposal": ["無料青果市場プロジェクト提案 PowerPoint", "地域青果市場提案"],
    "consultative-sales-strategy-report": ["無料営業戦略レポート PowerPoint テンプレート", "提案型営業戦略レポート"],
    "water-cycle-science-lesson": ["無料水循環理科授業 PowerPoint テンプレート", "水循環理科授業"],
    "adaptive-reuse-architecture-thesis-defense": ["無料建築論文審査 PowerPoint テンプレート", "建築再生論文審査"],
    "cardiac-rehabilitation-clinical-case": ["無料循環器臨床症例 PowerPoint テンプレート", "心臓リハビリ症例"],
    "machine-learning-model-evaluation": ["無料機械学習 PowerPoint テンプレート", "機械学習モデル評価"],
    "independent-musician-portfolio": ["無料ミュージシャン・ポートフォリオ PowerPoint", "独立音楽家ポートフォリオ"],
    "product-launch-timeline-roadmap": ["無料製品発売ロードマップ PowerPoint", "製品発売タイムライン"],
  },
  ko: {
    "precision-agriculture-business-plan": ["무료 정밀 농업 사업계획서 PowerPoint 템플릿", "정밀 농업 사업계획서"],
    "regenerative-food-marketplace-pitch-deck": ["무료 유기농 식품 스타트업 피치덱", "재생 식품 마켓 피치덱"],
    "mobile-kitchen-company-profile": ["무료 푸드트럭 회사 소개 PowerPoint 템플릿", "이동식 주방 회사 소개"],
    "artisan-bakery-marketing-plan": ["무료 베이커리 마케팅 계획 PowerPoint 템플릿", "장인 베이커리 마케팅"],
    "neighborhood-produce-market-proposal": ["무료 신선식품 시장 프로젝트 제안 템플릿", "지역 신선식품 시장 제안"],
    "consultative-sales-strategy-report": ["무료 영업 전략 보고서 PowerPoint 템플릿", "컨설팅 영업 전략 보고서"],
    "water-cycle-science-lesson": ["무료 물의 순환 과학 수업 PowerPoint 템플릿", "물의 순환 과학 수업"],
    "adaptive-reuse-architecture-thesis-defense": ["무료 건축학 논문 발표 PowerPoint 템플릿", "건축 재생 논문 발표"],
    "cardiac-rehabilitation-clinical-case": ["무료 심장학 임상 사례 PowerPoint 템플릿", "심장 재활 임상 사례"],
    "machine-learning-model-evaluation": ["무료 머신러닝 PowerPoint 템플릿", "머신러닝 모델 평가"],
    "independent-musician-portfolio": ["무료 뮤지션 포트폴리오 PowerPoint 템플릿", "인디 뮤지션 포트폴리오"],
    "product-launch-timeline-roadmap": ["무료 제품 출시 로드맵 PowerPoint 템플릿", "제품 출시 타임라인"],
  },
  fr: {
    "precision-agriculture-business-plan": ["Modèle PowerPoint gratuit de business plan d’agriculture de précision", "Business plan d’agriculture de précision"],
    "regenerative-food-marketplace-pitch-deck": ["Pitch deck gratuit de startup alimentaire bio", "Pitch de marché alimentaire régénératif"],
    "mobile-kitchen-company-profile": ["Modèle PowerPoint gratuit de profil de food truck", "Profil de cuisine mobile"],
    "artisan-bakery-marketing-plan": ["Modèle PowerPoint gratuit de plan marketing de boulangerie", "Plan marketing de boulangerie artisanale"],
    "neighborhood-produce-market-proposal": ["Modèle PowerPoint gratuit de projet de marché de produits frais", "Projet de marché de quartier"],
    "consultative-sales-strategy-report": ["Modèle PowerPoint gratuit de rapport de stratégie commerciale", "Rapport de vente consultative"],
    "water-cycle-science-lesson": ["Modèle PowerPoint gratuit de cours sur le cycle de l’eau", "Cours sur le cycle de l’eau"],
    "adaptive-reuse-architecture-thesis-defense": ["Modèle PowerPoint gratuit de soutenance en architecture", "Soutenance sur la réutilisation adaptative"],
    "cardiac-rehabilitation-clinical-case": ["Modèle PowerPoint gratuit de cas clinique en cardiologie", "Cas de réadaptation cardiaque"],
    "machine-learning-model-evaluation": ["Modèle PowerPoint gratuit sur l’apprentissage automatique", "Évaluation d’un modèle ML"],
    "independent-musician-portfolio": ["Modèle PowerPoint gratuit de portfolio de musicien", "Portfolio de musicien indépendant"],
    "product-launch-timeline-roadmap": ["Modèle PowerPoint gratuit de feuille de route de lancement produit", "Chronologie de lancement produit"],
  },
  es: {
    "precision-agriculture-business-plan": ["Plantilla PowerPoint gratis de plan de negocio de agricultura de precisión", "Plan de agricultura de precisión"],
    "regenerative-food-marketplace-pitch-deck": ["Pitch deck gratis para startup de alimentos orgánicos", "Pitch de mercado alimentario regenerativo"],
    "mobile-kitchen-company-profile": ["Plantilla PowerPoint gratis de perfil de food truck", "Perfil de cocina móvil"],
    "artisan-bakery-marketing-plan": ["Plantilla PowerPoint gratis de plan de marketing de panadería", "Plan de panadería artesanal"],
    "neighborhood-produce-market-proposal": ["Plantilla PowerPoint gratis de propuesta de mercado de productos frescos", "Propuesta de mercado vecinal"],
    "consultative-sales-strategy-report": ["Plantilla PowerPoint gratis de informe de estrategia de ventas", "Informe de venta consultiva"],
    "water-cycle-science-lesson": ["Plantilla PowerPoint gratis de clase sobre el ciclo del agua", "Clase sobre el ciclo del agua"],
    "adaptive-reuse-architecture-thesis-defense": ["Plantilla PowerPoint gratis de defensa de tesis de arquitectura", "Defensa de reutilización adaptativa"],
    "cardiac-rehabilitation-clinical-case": ["Plantilla PowerPoint gratis de caso clínico de cardiología", "Caso de rehabilitación cardíaca"],
    "machine-learning-model-evaluation": ["Plantilla PowerPoint gratis de aprendizaje automático", "Evaluación de modelos ML"],
    "independent-musician-portfolio": ["Plantilla PowerPoint gratis de portafolio de músico", "Portafolio de músico independiente"],
    "product-launch-timeline-roadmap": ["Plantilla PowerPoint gratis de hoja de ruta de lanzamiento de producto", "Cronología de lanzamiento de producto"],
  },
  ru: {
    "precision-agriculture-business-plan": ["Бесплатный шаблон бизнес-плана точного земледелия PowerPoint", "Бизнес-план точного земледелия"],
    "regenerative-food-marketplace-pitch-deck": ["Бесплатный питч-дек стартапа органических продуктов", "Питч регенеративного рынка продуктов"],
    "mobile-kitchen-company-profile": ["Бесплатный шаблон презентации фудтрака", "Профиль мобильной кухни"],
    "artisan-bakery-marketing-plan": ["Бесплатный шаблон маркетингового плана пекарни", "План ремесленной пекарни"],
    "neighborhood-produce-market-proposal": ["Бесплатный шаблон проекта продуктового рынка", "Проект районного рынка"],
    "consultative-sales-strategy-report": ["Бесплатный шаблон отчёта о стратегии продаж", "Отчёт о консультативных продажах"],
    "water-cycle-science-lesson": ["Бесплатный шаблон урока о круговороте воды", "Урок о круговороте воды"],
    "adaptive-reuse-architecture-thesis-defense": ["Бесплатный шаблон защиты диссертации по архитектуре", "Защита по адаптивному использованию"],
    "cardiac-rehabilitation-clinical-case": ["Бесплатный шаблон клинического случая по кардиологии", "Случай кардиореабилитации"],
    "machine-learning-model-evaluation": ["Бесплатный шаблон презентации о машинном обучении", "Оценка модели машинного обучения"],
    "independent-musician-portfolio": ["Бесплатный шаблон портфолио музыканта PowerPoint", "Портфолио независимого музыканта"],
    "product-launch-timeline-roadmap": ["Бесплатный шаблон дорожной карты запуска продукта", "График запуска продукта"],
  },
};

export function localizedTemplateName(template: PptTemplate, locale: Locale) {
  const names = localized20260911Round2Names[locale]?.[template.slug] ?? localized20260911Names[locale]?.[template.slug] ?? localized20260910Round2Names[locale]?.[template.slug] ?? localized20260910Names[locale]?.[template.slug] ?? localizedDailyNames[locale]?.[template.slug] ?? localizedNames[locale]?.[template.slug];
